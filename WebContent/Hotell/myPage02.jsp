...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#reg").on('click', function(){
			...
			document.frm.action = "mypageOk02.jsp";
        ...
        <div class="container">
            <div class="leftsidebar">
                <ul>
                    ...
                    <li><a href="여기 상원님이 하신 예약 내역 페이지 이동하는 곳">예약내역</a></li>
                </ul>
            </div>
            <br>
         ...
         <form name="frm" id="frm" action = 'mypageOk02.jsp'> 
          
         <div class="id1">
 
			<div>
					<h2 id="id1">아이디</h2>
					<input type="text" name="id" id="id" placeholder=" <%=id2%>"
