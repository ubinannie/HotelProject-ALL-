...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#idCheck").on('click', function(){
			console.log('click');
			window.open("idcheckForm02.jsp","idcheckForm02","width=400, height=300");
		}); 
		...
		$("#reg").on('click', function(){
			...
			// 회원가입 성공했을때 DB연동 페이지로 넘어감으로 get방식으로 보내서 확인 
			document.frm.action = "registerOk011.jsp";
...
<div class="body__container">
	...
	<div id="regDiv">
		...
		<form name="frm" id="frm" action = 'registerOk011.jsp'>
		
			<h2 id="in">회원가입</h2>
			
			<div>
					<h2 id="id1">아이디</h2>
					<input type="text" name="ad_id" id="id" 
