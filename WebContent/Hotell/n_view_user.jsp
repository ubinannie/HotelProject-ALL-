...
//로긴 한사람이면 ad_id라는 변수에 해당 아이디가 담기고 그렇지 않으면 null값
		...
		if (n_no == 0) {
			...
			script.println("location.href = 'notice_user.jsp'");
			script.println("</script>");
		}
    ...
    <div class="body__container">
        ...
        <div class="container">
            ...
            <div class="contents">
                ...
                <div id="option">
                		<a href="notice_user.jsp" class="notice-btn">목록</a>
					<%
				//글작성자 본인일시 수정 삭제 가능
						if (ad_id != null && ad_id.equals(vo.getAd_id())) {
					%>
						<a href="update.jsp?n_no=<%=n_no %>" class="notice-btn" >수정</a>
						<a href="delete.jsp?n_no=<%=n_no %>" class="notice-btn" id="delConfirm">삭제</a>
					<%
					}
					%>
                </div>
