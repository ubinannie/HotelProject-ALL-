	...
	$(function(){
		...
		$(".delConfirm").on('click', function() {
			...
			if (flag) {
				...
				location.href = "delete_review_userOk.jsp?r_no=" + no;
			}
		});
	...
	<div class="container">
		...
		<div id="tab-3" class="tab-content">
			<div class="write_review">
				<a href="write_review.jsp">
				<input type="button" value="리뷰쓰기"	id="writeBtn" /></a>
			</div>
			<ul>
				<li>
					<div class="guest">
			...
			<div class="paging">
				...
				%>
				<a href="hotelReview_user.jsp?cp=<%=i%>"><span id="page"><%=i%></span></a>
				<%
					} // if end
					} // for end
				%>
