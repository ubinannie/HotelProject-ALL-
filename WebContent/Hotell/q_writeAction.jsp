...
<jsp:useBean id="question" class="question.questionVO" scope="page" />
<jsp:setProperty name="question" property="title" />
<jsp:setProperty name="question" property="content" /> 
...
%>
	...
	if(ad_id == null){
		...
		if(question.getTitle() == null || question.getContent() == null){
			...
			int result = questionDAO.write(ad_id, question.getTitle(), question.getContent());
			if(result == -1){
				PrintWriter script = response.getWriter();
				script.println("<script>");
