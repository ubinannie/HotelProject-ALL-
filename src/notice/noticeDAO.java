...
public class noticeDAO {
	...
	public int write(String ad_id, String title, String content) {
		...
		sb.append(" values(notice_n_no_seq.nextval, ?, ?, sysdate, ? ) ");
	...
	public ArrayList<noticeVO> getAllData(int startNo, int endNo){
		...
		try {
			...
			while(rs.next()) {
				...
				noticeVO vo = new noticeVO(n_no, ad_id, title, regdate, content);
